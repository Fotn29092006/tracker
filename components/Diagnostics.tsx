...
export function Diagnostics() {
  ...
  if (m) {
    if (!standalone) {
      ...
      verdict = `content-viewport на ${deficit}px короче экрана (особенность iOS, не лечится высотой). Но меню теперь прибито к настоящему низу через position:fixed bottom:0 — как в рабочем posuda. Меню должно стоять вплотную к низу, без полосы. Проверь глазами.`;
    }
  }
